...
import ru.mts.HW5.model.Cat;
import ru.mts.HW5.model.Dog;
...
public class Main {
    public static void main(String[] args) {
        ...
        AbstractAnimal[] duplicates = (AbstractAnimal[]) searchService.findDuplicate(animals);

        if (duplicates.length > 0) {
            System.out.println("Дубликаты:");
            for (AbstractAnimal animal : duplicates) {
                System.out.println(animal);
            }
            System.out.println("Количество: " + duplicates.length);
        } else {
            System.out.println("Дубликатов нет");
        }
        System.out.println("Проверка на дубликаты у 2 массива:");
        AbstractAnimal[] duplicates2 = (AbstractAnimal[]) searchService.findDuplicate(animals2);

        if (duplicates2.length > 0) {
            System.out.println("Дубликаты:");
            for (AbstractAnimal animal : duplicates2) {
                System.out.println(animal);
            }
            System.out.println("Количество: " + duplicates2.length);
        } else {
            System.out.println("Дубликатов нет");
        }
